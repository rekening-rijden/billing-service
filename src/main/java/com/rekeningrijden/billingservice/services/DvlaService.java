...
public class DvlaService {
    ...
    public ResponseEntity<?> getVehicleByRegistrationNumber(String registrationNumber) throws IOException, InterruptedException {
        ...
        return ResponseEntity.ok(postResponse.body());
    }
}
